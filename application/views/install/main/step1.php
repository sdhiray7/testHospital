    ...
    <div class="panel panel-primary" data-collapsed="0"
      style="border-color: #dedede;">
        ...
        <?php if ($valid == true) { ?>
          <p>
            <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
              <a href="<?php echo base_url();?>index.php?install/step3" class="btn btn-info">
                Continue
              </a>
            <?php } else { ?>
              <a href="<?php echo base_url();?>index.php?install/step2" class="btn btn-info">
                Continue
              </a>
            <?php } ?>
          </p>
        ...
        <?php if ($valid != true) { ?>
          <p>
            <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
              <a href="<?php echo base_url();?>index.php?install/step3" class="btn btn-info" disabled>
                Continue
              </a>
            <?php } else { ?>
              <a href="<?php echo base_url();?>index.php?install/step2" class="btn btn-info" disabled>
                Continue
              </a>
            <?php } ?>
            <a href="<?php echo base_url();?>index.php?install/step1" class="btn btn-info" >
