    ...
    <div class="panel panel-primary" data-collapsed="0"
      style="border-color: #dedede;">
        ...
        <p style="font-size: 14px;">
          Welcome to Bayanno Hospital Management System Installation. You will need to know the following items before
          proceeding.
        </p>
        <ol>
        ...
        <p style="font-size: 14px;">
          ...
          <strong>write permission</strong>. We will also check if <strong>curl</strong> is
