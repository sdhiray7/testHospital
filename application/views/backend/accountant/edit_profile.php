...
$single_accountant_info = $this->db->get_where('accountant', array('accountant_id' => $accountant_id))->result_array();
foreach ($single_accountant_info as $row) {
?>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?accountant/manage_profile/update" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?accountant/manage_profile/change_password" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('old_password'); ?></label>

                            <div class="col-sm-5">
                                <input type="password" name="old_password" class="form-control" id="field-1" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="password" name="new_password" class="form-control" id="field-1" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="password" name="confirm_new_password" class="form-control" id="field-1" required>
                            </div>
                        </div>
