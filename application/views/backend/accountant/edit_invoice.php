        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(base_url() . 'index.php?accountant/invoice_manage/update/' . $param2, array('class' => 'form-horizontal form-groups invoice-edit', 'enctype' => 'multipart/form-data')); ?>
