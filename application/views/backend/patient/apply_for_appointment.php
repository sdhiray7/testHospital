                ...
                <form role="form" class="form-horizontal form-groups" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="date-and-time">
                                <input type="text" name="date_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy" placeholder="date here" required>
                    ...
                    <div class="col-sm-3 col-sm-offset-2">
                        <button type="submit" class="btn btn-success">
                            <i class="fa fa-check"></i> <?php echo get_phrase('request_appointment');?>
                        </button>
                    </div>
                </form>
