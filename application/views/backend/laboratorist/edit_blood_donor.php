        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?laboratorist/blood_donor/update/<?php echo $row['blood_donor_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea rows="5" name="address" class="form-control" id="field-ta">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="last_donation_timestamp" class="form-control datepicker" id="field-1" value="<?php echo date("m/d/Y", $row['last_donation_timestamp']); ?>" required>
                            </div>
                        </div>
