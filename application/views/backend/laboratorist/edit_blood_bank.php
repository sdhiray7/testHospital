        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?laboratorist/blood_bank/update/<?php echo $row['blood_group_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="status" class="form-control" id="field-1" value="<?php echo $row['status']; ?>" required>
                            </div>
                        </div>
