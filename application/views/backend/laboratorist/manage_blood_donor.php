<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/add_blood_donor/');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('add_blood_donor'); ?>
</button>
        ...
        <?php foreach ($blood_donor_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?laboratorist/blood_donor/delete/<?php echo $row['blood_donor_id'];?>')"
