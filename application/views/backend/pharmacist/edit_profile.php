...
$single_pharmacist_info = $this->db->get_where('pharmacist', array('pharmacist_id' => $pharmacist_id))->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?pharmacist/manage_profile/update" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?pharmacist/manage_profile/change_password" method="post" enctype="multipart/form-data">
