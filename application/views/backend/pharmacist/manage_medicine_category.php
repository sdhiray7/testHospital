<button onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/add_medicine_category/');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('add_medicine_category'); ?>
</button>
        ...
        <?php foreach ($medicine_category_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?pharmacist/medicine_category/delete/<?php echo $row['medicine_category_id']; ?>')"
