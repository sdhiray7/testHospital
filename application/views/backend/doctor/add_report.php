    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?doctor/report/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea name="description" rows="5" class="form-control" id="field-ta"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="file" class="file2 btn btn-primary" multiple="multiple" data-label="&nbsp;Browse Files"
