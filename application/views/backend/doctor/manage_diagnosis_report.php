        ...
        <?php foreach ($diagnosis_report_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?doctor/diagnosis_report/delete/<?php echo $row['diagnosis_report_id'];?>')"
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?doctor/diagnosis_report/create" method="post" enctype="multipart/form-data">
