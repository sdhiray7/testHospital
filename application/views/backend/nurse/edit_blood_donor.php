        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?nurse/blood_donor/update/<?php echo $row['blood_donor_id']; ?>" method="post" enctype="multipart/form-data">
