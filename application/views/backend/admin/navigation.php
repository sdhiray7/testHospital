    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_accountant') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/accountant">
                ...
                <span><?php echo get_phrase('accountant') . " / " . get_phrase('receptionist'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'show_payment_history' || $page_name == 'show_bed_allotment'
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'show_payment_history_by_doctor') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/payment_history_by_doctor">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('payment_history_by_doctor'); ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'frontend') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?admin/frontend">
        ...
        <li class="<?php if ($page_name == 'contact_email') echo 'active'; ?>">
            <a href="<?php echo base_url(); ?>index.php?admin/contact_email">
