<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/add_receptionist/');" 
        ...
        <?php foreach ($receptionist_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/receptionist/delete/<?php echo $row['receptionist_id'];?>')"
