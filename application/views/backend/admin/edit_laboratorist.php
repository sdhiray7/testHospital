<?php
$single_laboratorist_info = $this->db->get_where('laboratorist', array('laboratorist_id' => $param2))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_laboratorist'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?admin/laboratorist/update/<?php echo $row['laboratorist_id']; ?>" method="post" enctype="multipart/form-data">
