        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('add_service'); ?></h3>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups validate"
                      action="<?php echo base_url(); ?>index.php?admin/frontend_settings/service_new"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="title" class="form-control" id="field-1" placeholder="<?php echo get_phrase('enter_service_title');?>" required>
                        </div>
                    </div>
