<?php
$single_nurse_info = $this->db->get_where('nurse', array('nurse_id' => $param2))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_nurse'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups" action="<?php echo base_url(); ?>index.php?admin/nurse/update/<?php echo $row['nurse_id']; ?>" method="post" enctype="multipart/form-data">
