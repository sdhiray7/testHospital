<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/add_nurse/');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_nurse'); ?>
</button>
        ...
        <?php foreach ($nurse_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/nurse/delete/<?php echo $row['nurse_id'];?>')"
