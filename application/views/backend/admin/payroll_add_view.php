    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label" style="margin-bottom: 11px;"><?php echo get_phrase('employee'); ?></label>
        ...
        <div class="col-md-3" style="margin-top: 27px;">
            <button type="submit" class="btn btn-info" style="width: 100%;">
                <?php echo get_phrase('generate_payslip'); ?></button>
        </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('allowances'); ?></h4>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('deductions'); ?></h4>
                    </div>
                </div>
                <div class="panel-body ">
                    <span id="deduction">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('payroll_summary'); ?></h4>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-check"></i> <?php echo get_phrase('create_payslip'); ?>
                            </button>
                        </div>
                    </div>
                </div>
